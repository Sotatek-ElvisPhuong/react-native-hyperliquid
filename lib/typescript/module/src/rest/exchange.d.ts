...
export declare class ExchangeAPI {
    ...
    constructor(testnet: boolean, privateKey: string, rateLimiter: RateLimiter, symbolConversion: SymbolConversion, walletAddress: (string | null) | undefined, parent: Hyperliquid, vaultAddress?: string | null);
