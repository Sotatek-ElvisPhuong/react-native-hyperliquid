...
import type { OrderResponse, TriggerOrderTypeWire, Builder } from '../types';
...
export declare class CustomOperations {
     ...
     */
    marketOpen(symbol: string, isBuy: boolean, size: number, px?: number, triggers?: TriggerOrderTypeWire[], slippage?: number, builder?: Builder): Promise<OrderResponse>;
    /**
     ...
     * @returns A promise that resolves to the OrderResponse.
     */
    makePositionTpSl(symbol: string, isBuy: boolean, size: number, triggers?: TriggerOrderTypeWire[], slippage?: number, builder?: Builder): Promise<OrderResponse>;
    /**
     ...
     * @returns A promise that resolves to the OrderResponse.
     */
    marketClose(symbol: string, size?: number, px?: number, slippage?: number, cloid?: string, builder?: Builder): Promise<OrderResponse>;
    /**
     ...
     * @returns A promise that resolves to the OrderResponse.
     */
    limitOpen(symbol: string, isBuy: boolean, size: number, px: number, triggers?: TriggerOrderTypeWire[], slippage?: number, builder?: Builder): Promise<OrderResponse>;
}
